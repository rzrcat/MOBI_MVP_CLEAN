...
/* harmony export */   t: () => (/* binding */ SegmentedProgressBar)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(85893);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16689);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* __next_internal_client_entry_do_not_use__ SegmentedProgressBar auto */ 
 ...
 */ function SegmentedProgressBar({ total, completed, color = "blue", customColor, onClick }) {
    const colorSteps = {
        blue: [
            "bg-blue-200",
            "bg-blue-300",
    ...
    if (color === "custom" && customColor) {
        return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
            className: "battery-bar flex gap-1 w-full max-w-[10rem] h-7 select-none",
            children: Array.from({
                length: total
            }).map((_, i)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                    type: "button",
    ...
    const stepColors = colorSteps[color] || colorSteps.blue;
    const borderColor = borderSteps[color] || "border-blue-200";
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        className: "battery-bar flex gap-1 w-full max-w-[10rem] h-7 select-none",
        children: Array.from({
            length: total
